...
var listProxy = [
  { path: "/vl=103.67.79.230:443", proxy: "103.67.79.230:443" },  
...
<div class="config-section">
    ...
    <div class="config-toggle">
        ...
        <div class="config-content">
          ...
          <p class="config">» cache.netflix.com <button class="button2" onclick='copyClash("clashTls8${path}")'><i class="fa fa-clipboard"></i>Copy</button></p>
          ...
          <p class="config">» io.ruangguru.com <button class="button2" onclick='copyClash("clashTls10${path}")'><i class="fa fa-clipboard"></i>Copy</button></p>
...
<body><header><p class="noted877">JEMBUT TERBAKAT</p></header>
